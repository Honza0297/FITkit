...
set ( LIBFTDI_FOUND 1 )
set ( LIBFTDI_USE_FILE     "/app/lib64/cmake/libftdi1/UseLibFTDI1.cmake" )

set ( LIBFTDI_DEFINITIONS  "" )
set ( LIBFTDI_INCLUDE_DIR  "/app/include/libftdi1" )
set ( LIBFTDI_INCLUDE_DIRS "/app/include/libftdi1" )
set ( LIBFTDI_LIBRARY      "ftdi1" )
set ( LIBFTDI_LIBRARIES    "ftdi1;/app/lib/libusb-1.0.so" )
set ( LIBFTDI_STATIC_LIBRARY      "ftdi1.a" )
set ( LIBFTDI_STATIC_LIBRARIES    "ftdi1.a;/app/lib/libusb-1.0.so" )
set ( LIBFTDIPP_LIBRARY    "" )
set ( LIBFTDIPP_LIBRARIES  "" )
set ( LIBFTDI_LIBRARY_DIRS "/app/lib64" )
set ( LIBFTDI_ROOT_DIR     "/app" )
