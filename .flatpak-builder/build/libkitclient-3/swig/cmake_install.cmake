...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xpythonx" OR NOT CMAKE_INSTALL_COMPONENT)
  message("Python: Create .pyc and .pyo files")
                      execute_process(COMMAND python -m compileall /run/build/libkitclient/python
                                      COMMAND python -O -m compileall /run/build/libkitclient/python
                                      OUTPUT_QUIET)
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xpythonx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/../usr/lib/python2.7/site-packages" TYPE FILE FILES
    "/run/build/libkitclient/python/fitkit.py"
    "/run/build/libkitclient/python/fitkit.pyc"
    "/run/build/libkitclient/python/fitkit.pyo"
    )
endif()
